...
int main()
{
    ...
    cout<<"Press 1 for completely random binary sequence\nPress 2 for random binary sequence with fixed subsequences\nPress 3 for custom input..."<<endl;
    int flager;
    cin>>flager;
    if(flager==2)
    {
    ...
    {
        cout<<"Enter the length of Custom Input:"<<endl;
        int x;
        cin>>x;
        cout<<"Enter "<<x<<" bits:"<<endl;
        for(int i=0;i<x;i++)
        {
            int z;
            cin>>z;
